import { Flex, Box, Text, Input, InputAddon, Group } from "@chakra-ui/react";
...
export const SettingsPage = () => {
  ...
  return (
    <Flex direction="column" gap={6} p={6} bg={bgColor} borderRadius="md" boxShadow="md">
      ...
      <Box bg={cardBgColor} p={4} borderRadius="md" boxShadow="sm">
        ...
        <Group mb={4} attached>
          ...
          <Input
            ...
            readOnly
          />
          <InputAddon><DiscordLink username={profile.name} /> </InputAddon>
        </Group>
      </Box>
      {/* <Box bg={cardBgColor} p={4} borderRadius="md" boxShadow="sm">
        <Text fontSize="lg" fontWeight="bold" mb={2} color={textColor}>
        ...
        <Text color="gray.500">
          Получите новые впечатления от игры и уникальные функции на нашем сайте с временной подпиской.
        </Text>
